...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-surface border-r border-white/5 flex flex-col">
      {/* Logo */}
      ...
      <div className="p-4 border-t border-white/5">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-muted hover:text-white hover:bg-surface-light transition-colors w-full"
        >
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
